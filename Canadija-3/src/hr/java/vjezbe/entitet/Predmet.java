...
public class Predmet {
	 ...
	 * @throws NeispravanNazivPredmeta 
	 */
	public static Predmet unosPredmeta(Scanner scanner, int redniBroj, Profesor[] profesori) throws NeispravanNazivPredmeta {
		redniBroj++;
		...
		if (!naziv.matches("[a-zA-z ]*")) throw new NeispravanNazivPredmeta();
